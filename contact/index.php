...
toute question, suggestion ou assistance. <img src="images/undraw-contact.svg" alt="Image" class="img-fluid"> </p>
            ...
            <div class="col-md-6">
              ...
              <form class="mb-5" method="post" id="contactForm" name="contactForm">
                ...
                <div class="row">
                  <div class="col-md-12 form-group">
                    <textarea class="form-control" name="message" id="message" cols="30" rows="7" placeholder="Rédigez votre message"></textarea>
                  </div>
                </div>  
                <div class="row">
                  <div class="col-12">
                    <input type="submit" value="Envoyer message" class="btn btn-primary rounded-0 py-2 px-4">
